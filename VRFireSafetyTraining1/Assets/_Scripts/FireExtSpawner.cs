...
namespace Valve.VR.InteractionSystem
{
    ...
    public class FireExtSpawner : MonoBehaviour
    {
        ...
        private void OnHandHoverBegin(Hand hand)
        {
            ...
            if (!requireGrabActionToTake) // we don't require trigger press for pickup. Spawn and attach object.
            {
                ...
                Debug.Log("OnHandHoverBegin invoked");
            }
        ...
        private void TakeBackItem(Hand hand)
        {
            ...
            if (itemPackage.packageType == ItemPackage.ItemPackageType.TwoHanded)
            {
                ...
                Debug.Log("takeBackItem back item is called");
            }
        }
        ...
        public void switchExt(Hand hand)
        {
            OnHandHoverBegin(hand);
            Debug.Log("spawn new fire ext");
        }
        //-------------------------------------------------
